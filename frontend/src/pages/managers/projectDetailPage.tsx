  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <div className="flex items-center gap-2 text-gray-600 bg-white px-3 py-1 rounded-full shadow-sm">
          ...
          <Dialog>
            <DialogTrigger>
              <button className="inline-flex items-center px-4 py-2 bg-white border-2 border-gray-300 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 hover:border-blue-300 text-gray-700">
          ...
          <button
            className="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 hover:bg-red-700"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="p-6 rounded-2xl shadow-xl border-0 bg-gradient-to-br from-blue-500 to-blue-600 text-white hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="p-6 rounded-2xl shadow-xl border-0 bg-gradient-to-br from-emerald-500 to-emerald-600 text-white hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
          <div className="flex items-center justify-between">
            <div>
        ...
        <div className="p-6 rounded-2xl shadow-xl border-0 bg-gradient-to-br from-purple-500 to-purple-600 text-white hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-purple-100 text-sm font-medium">
                Active Status
              </p>
              <p className="text-3xl font-bold">{project.status}</p>
            </div>
      ...
      {/* Project Info Card */}
      <div className="mb-8 p-8 rounded-3xl shadow-2xl border-0 bg-white/80 backdrop-blur-sm hover:shadow-3xl transition-all duration-300">
          ...
          <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-3">
                {project.requiredSkills &&
                  ...
                  project.requiredSkills.map((skill, index) => (
                    <span
                      key={skill}
                      className="px-4 py-2 text-sm font-medium bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl border border-emerald-100">
                ...
                <div>
                  <p className="text-sm text-gray-600">Team Composition</p>
                  <p className="font-semibold text-gray-800">
      ...
      {/* Assignments Table */}
      <div className="p-8 rounded-3xl shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
        ...
        {assignments.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-lg">No engineers assigned yet.</p>
          </div>
        ) : (
            ...
            <table className="min-w-full">
              <thead>
                <tr className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl">
                  <th className="py-4 px-6 text-left text-sm font-semibold text-gray-700 rounded-l-xl">
                    Engineer
                  </th>
                  ...
                  <th className="py-4 px-6 text-left text-sm font-semibold text-gray-700 rounded-r-xl">
                    Priority
                  </th>
                </tr>
              </thead>
                    ...
                    >
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 flex items-center justify-center font-bold text-white shadow-lg group-hover:shadow-xl transition-all duration-200">
                            {eng?.avatar || "?"}
                          </div>
                          <div>
                            <p className="font-semibold text-gray-800">
